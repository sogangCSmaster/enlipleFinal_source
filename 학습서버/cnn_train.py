...
def train_cnn():
    ...
    out_dir = os.path.abspath(os.path.join(os.path.curdir, "trained_model_" + model_folder_name))
    os.rename("./labels.json", "./trained_model_"+model_folder_name+"/labels.json")
    ...
    os.rename("./category.json", "./trained_model_"+model_folder_name+"/category.json")
    cateFile.close()
            ...
            for train_batch in train_batches:
                ...
                if current_step % params['evaluate_every'] == 0:
                    ...
                    if dev_accuracy >= best_accuracy:
                        ...
                        checkpointFile = open('./trained_model_'+model_folder_name+'/checkpoints/checkpoint', 'w')
                        checkpointFile.write("model_checkpoint_path: \"model-"+str(best_at_step)+"\"")
